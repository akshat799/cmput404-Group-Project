...
//INBOX
export const getInbox = (author_id) =>api.get(`backendapi/authors/${author_id}/inbox`);
export const sendRequest = (foreign_author_id, data) =>api.post(`backendapi/authors/${foreign_author_id}/inbox`, data);
export const getInboxPostsLikes = (author_id) =>api.post(`backendapi/authors/${author_id}/inbox/like`);
export const sendPost = (author_id, data) =>api.post(`backendapi/authors/${author_id}/inbox`, data);
